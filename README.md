...
Bullets are using bounding box detection and have ray caste hit scan implemented as well but is inactive while still showing the tracer. The entities also use bounding box detection for bullet collision.<img src="https://github.com/Kingerthanu/CPP_3D_OpenGLEngine/assets/76754592/5e4ad275-8357-45ca-9c2e-4af4921ae1f1" alt="Cornstarch <3" width="95" height="99">
